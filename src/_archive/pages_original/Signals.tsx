...
import { TrendingUp, Activity, Save, History, Settings2 } from "lucide-react";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight font-mono">Signals</h1>
          <p className="text-muted-foreground mt-1">
            Signal history and strategy configuration
          </p>
        </div>
        {hasChanges && (
